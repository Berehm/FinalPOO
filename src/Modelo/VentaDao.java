...
public class VentaDao {
    ...
    public void pdfV(int idventa, int Cliente, double total, String usuario) {
        try {
            ...
            proveedor.setWidths(new float[]{50f, 25f, 25f});
            ...
            try {
                con = cn.establecerconexion();   // <-- CORREGIDO
            ...
            String product = "SELECT d.id, d.id_pro, d.id_venta, d.precio, d.cantidad, p.id, p.nombre "
